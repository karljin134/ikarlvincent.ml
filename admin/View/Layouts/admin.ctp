...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>ADMIN | Karl Vincent Lim</title>
    <?php
...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo $this->Html->url('/user-manage/'); ?>"><i class="fa fa-users fa-fw"></i> Manage Users</a>
                        </li>
                        <li>
                            <a href="<?php echo $this->Html->url('/post-manage/'); ?>"><i class="fa fa-newspaper-o fa-fw"></i> Posts</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
    ...
    <?php 
        ...
        echo $this->Html->script('metisMenu.min'); // Include BOOTSTRAP SCRIPTS 
        echo $this->Html->script('raphael.min'); // Include BOOTSTRAP SCRIPTS
        echo $this->Html->script('morris.min'); // Include BOOTSTRAP SCRIPTS
        echo $this->Html->script('sb-admin-2'); // Include BOOTSTRAP SCRIPTS
